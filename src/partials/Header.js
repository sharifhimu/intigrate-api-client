      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-6">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div className="flex-shrink-0 mr-4">
            {/* Logo */}
            <Link to={ localStorage.getItem('logged') == 'true' ? "/" : "/signin" } className="block" aria-label="Cruip">
            ...
            <ul className="flex flex-grow justify-end flex-wrap items-center">
              {
                ...
                <li>
                <Link to="/signin" onClick={ () => localStorage.setItem('logged', 'false') } className="font-medium text-gray-600 hover:text-gray-900 px-5 py-3 flex items-center transition duration-150 ease-in-out">Log out</Link>
                </li>
                :
                <>
                <li>
